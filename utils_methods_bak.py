...
def train_FedAvg(
    ...
    for i in range(args.comm_round):            
        ...
        for clnt in selected_clnts:
            ...
            # clnt_models[clnt].load_state_dict(copy.deepcopy(dict(fed_model.named_parameters())))
        ...
        for clnt in selected_clnts:
            ...
            if clnt == 0:
                ...
                for key in net_para:
                    fed_para[key] += net_para[key] * weight_list[clnt]
        fed_model.load_state_dict(fed_para)
        # fed_model = set_client_from_params(init_model, np.sum(clnt_params_list*weight_list/np.sum(weight_list), axis = 0)) # model aggregation?
